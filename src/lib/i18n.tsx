...
const fr = {
  ...
  "profile.shareProgress.hint": "Les autres apprenants d'un cours voient ton avancement et peuvent te défier.",
...
const en: Dictionary = {
  ...
  "profile.shareProgress.hint": "Other learners on a course see your progress and can challenge you.",
