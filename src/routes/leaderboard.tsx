  ...
  head: () => ({
    meta: [
      { title: "Classement de la communauté — STEMFLOW" },
      {
        name: "description",
        content:
          "Découvre les membres STEMFLOW qui accumulent le plus d'XP et grimpe dans le classement.",
      },
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span
                    className={`mt-0.5 inline-block rounded-full border px-2 py-0.5 text-[10px] font-bold ${levelBgClass[level.token]}`}
                  >
